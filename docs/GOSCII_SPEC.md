...
GOSCII is the narrative voice of every `story:` field in level.yaml.
...
Examples:
- "Supply Haul" - slices and maps puzzle
...
Fail -> error message + optional hint (press Ctrl+H)
```
...
|                                                      |
+------------------------------------------------------+
|  [Ctrl+R] run   [Ctrl+H] hint   [Ctrl+N] next   [Ctrl+C] quit  |
+------------------------------------------------------+
```
